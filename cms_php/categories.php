          ...
          <div class="row">
            <div class="col-md-4 dashboard-left-cell">
              <div class="admin-content-con">
                <header>
                  <h5>Stworz kategorie</h5>
                </header>
                <form>
                  <div class="form-group">
                    <label class="tag-title">Nowa kategoria:</label>
                    <p>
                      <span class="textarea-error">Pole nie moze być puste!</span>
                      <textarea class="form-control" rows="3" placeholder="Wpisz nową kategorie" id="tag-editor"></textarea>
                    </p>
                    <p class="tag-save"></p>
                  </div>
                </form>
